...
#define RDID_VW_Logical_Software_Block_Counter_Of_Programming_Attempts 0x0407
#define RDID_VW_Logical_Software_Block_Lock_Value 0x040F
#define RDID_BootloaderTPBlocksize 0x0410
#define RDID_ActiveDiagnosticSession 0xF186
#define RDID_VWSparePartNumber 0xF187
#define RDID_VW_logical_block_downgrade_protection_versions 0x0189
#define RDID_SoftwareVersionNumber 0xF189
#define RDID_VWECUHardwareNumber 0xF191
#define RDID_EngineType 0xF197
#define RDID_ASAM_ODX_File_Identifier 0xF19E
#define RDID_VWECUHardwareVersionNumber 0xF1A3
